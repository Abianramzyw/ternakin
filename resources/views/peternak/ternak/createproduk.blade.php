...
@section('container')
    ...
    <div class="col-lg-7">
        <form method="post" action="/peternak/datalaporan" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="nama_pemilik" class="form-label">Nama Produk</label>
                ...
                <div class="mb-3">
                    <label for="berat_ternak" class="form-label">Harga</label>
                ...
                <div class="mb-3">
                    <label for="jenis_ternak" class="form-label">Stok</label>
