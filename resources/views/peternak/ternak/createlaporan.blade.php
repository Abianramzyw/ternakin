    ...
    <div class="col-lg-7">
        <form method="post" action="/peternak/datalaporan" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="jenis_ternak" class="form-label">Kondisi Ternak</label>
                ...
                <div class="mb-3">
                    <label for="status_terjual" class="form-label">Status Vaksinasi</label>
                    <input type="text" class="form-control" id="status_terjual" name="status_terjual">
                </div>
                <div class="mb-3">
                    <label for="status_terjual" class="form-label">Status Masa Subur</label>
                    <input type="text" class="form-control" id="status_terjual" name="status_terjual">
                </div>
                <div class="mb-3">
                    <label for="status_terjual" class="form-label">Status Pemeriksaan Rutin</label>
                    <input type="text" class="form-control" id="status_terjual" name="status_terjual">
                </div>
                <div class="mb-3">
