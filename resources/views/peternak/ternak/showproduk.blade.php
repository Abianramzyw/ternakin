    ...
    <div class="container">
        <div class="row my-3">
            <div class="col-lg-8">
                ...
                <a href="/peternak/dataternak/{{ $produkternaks->slug }}/edit" class="btn btn-warning"><span
                        data-feather="edit"></span> Edit Data</a>
                <form action="/peternak/dataternak/{{ $produkternaks->slug }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
